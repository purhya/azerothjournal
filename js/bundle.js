!function(){return function e(t,i,s){function n(o,l){if(!i[o]){if(!t[o]){var a="function"==typeof require&&require;if(!l&&a)return a(o,!0);if(r)return r(o,!0);var h=new Error("Cannot find module '"+o+"'");throw h.code="MODULE_NOT_FOUND",h}var c=i[o]={exports:{}};t[o][0].call(c.exports,function(e){return n(t[o][1][e]||e)},c,c.exports,e,t,i,s)}return i[o].exports}for(var r="function"==typeof require&&require,o=0;o<s.length;o++)n(s[o]);return n}}()({1:[function(e,t,i){"use strict";var s=this&&this.__decorate||function(e,t,i,s){var n,r=arguments.length,o=r<3?t:null===s?s=Object.getOwnPropertyDescriptor(t,i):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(e,t,i,s);else for(var l=e.length-1;l>=0;l--)(n=e[l])&&(o=(r<3?n(o):r>3?n(t,i,o):n(t,i))||o);return r>3&&o&&Object.defineProperty(t,i,o),o};Object.defineProperty(i,"__esModule",{value:!0});const n=e("flit"),r=e("fui"),o=e("./game/data-manager"),l=e("ff");e("./components");const a=e("flit"),h=e("./components"),c=e("./translate");window.flit=a,r.theme.changeTheme("dark"),r.theme.set("backgroundColor","#222"),r.theme.set("layerBackgroundColor",new r.Color("#222").lighten(5).toString()),r.theme.set("borderRadius",2),r.theme.set("layerBorderRadius",2);let d=class extends r.Router{constructor(){super(...arguments),this.page=l.firstMatch(location.search,/\?(\w+)/),this.prepared=!1,this.selectedUserSideAndClass=l.storage.get("selectedUserSideAndClass",!1)}render(){if(!o.dataManager.fixedData)return null;if(!this.selectedUserSideAndClass)return n.html`<wow-app-entry
		...
		`}async onCreated(){o.dataManager.loader.on("progress",(e,t)=>{this.dataProgress=Math.floor(e/t*100)})}};p=s([n.define("wow-app-progress")],p),i.WoWAppProgress=p},{"./components":5,"./game/data-manager":12,"./translate":16,ff:46,flit:75,fui:129}],2:[function(e,t,i){"use strict";var s=this&&this.__decorate||function(e,t,i,s){var n,r=arguments.length,o=r<3?t:null===s?s=Object.getOwnPropertyDescriptor(t,i):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(e,t,i,s);else for(var l=e.length-1;l>=0;l--)(n=e[l])&&(o=(r<3?n(o):r>3?n(t,i,o):n(t,i))||o);return r>3&&o&&Object.defineProperty(t,i,o),o};Object.defineProperty(i,"__esModule",{value:!0});const n=e("flit");let r=class extends n.Component{constructor(){super(...arguments),this.icon=""}render(){return n.html`
		<template class="wow-button">
			<img src="https://wow.zamimg.com/images/wow/icons/medium/${this.icon}.jpg">
		</template>
		`}};r.properties=["icon"],r=s([n.define("wow-button")],r),i.WoWButton=r},{flit:75}],3:[function(e,t,i){"use strict";var s=this&&this.__decorate||function(e,t,i,s){var n,r=arguments.length,o=r<3?t:null===s?s=Object.getOwnPropertyDescriptor(t,i):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(e,t,i,s);else for(var l=e.length-1;l>=0;l--)(n=e[l])&&(o=(r<3?n(o):r>3?n(t,i,o):n(t,i))||o);return r>3&&o&&Object.defineProperty(t,i,o),o};Object.defineProperty(i,"__esModule",{value:!0});const n=e("flit"),r=e("../game/data-manager"),o=e("fui"),l=e("../game/types"),a=e("../translate"),h={[l.Class.Warrior]:"#c69b6d",[l.Class.Paladin]:"#f48cba",[l.Class.Hunter]:"#aad372",[l.Class.Rogue]:"#fff468",[l.Class.Priest]:"#ffffff",[l.Class.Shaman]:"#2359ff",[l.Class.Mage]:"#68ccef",[l.Class.Warlock]:"#9382c9",[l.Class.Druid]:"#ff7c0a"};let c=class extends o.Select{constructor(){super(...arguments),this.data=[[null,a.tr("Not limit@@0027")]].concat(Object.entries(r.dataManager.fixedData.classes).map(e=>[Number(e[0]),e[1].name]))}render(){return n.html`
		<f-select
			:style.color=${this.value?h[this.value]:""}
		/>
		`.inherit(super.render())}renderOptionStyle(e){return"color: "+(e?h[e]:"inherit")}};c=s([n.define("class-select")],c),i.ClassSelect=c},{"../game/data-manager":12,"../game/types":18,"../translate":16,flit:75,fui:129}],4:[function(e,t,i){"use strict";var s=this&&this.__decorate||function(e,t,i,s){var n,r=arguments.length,o=r<3?t:null===s?s=Object.getOwnPropertyDescriptor(t,i):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(e,t,i,s);else for(var l=e.length-1;l>=0;l--)(n=e[l])&&(o=(r<3?n(o):r>3?n(t,i,o):n(t,i))||o);return r>3&&o&&Object.defineProperty(t,i,o),o};Object.defineProperty(i,"__esModule",{value:!0});const n=e("flit"),r=e("../game/data-manager"),o=e("ff"),l=e("fui"),a=e("../wowhead"),h=e("./settings"),c=e("../translate"),d=e("./quality-select"),u=e("./item-comparer");let p=class extends l.Grid{constructor(){super(...arguments),this.orderedColumnName=o.storage.get("comparerGridOrderName","itemLevel"),this.orderedDirection=o.storage.get("comparerGridOrderDirection",""),this.shouldRenderSlotColumn=!1,this.shouldRenderScoreColumn=!1,this.averageScore=null,this.maxScore=null}get columns(){let e=[{name:"name",title:c.tr("Name@@0040"),orderBy:"zhcn"===r.dataManager.lang?void 0:"name",width:300,flex:1}];return this.shouldRenderSlotColumn&&e.push({name:"slot",title:c.tr("Slot@@0014"),width:100,orderBy:e=>e.slotCount}),e.push({name:"requiresLevel",title:c.tr("Requires level@@0033"),orderBy:"requiresLevel",width:100}),e.push({name:"itemLevel",title:c.tr("Item level@@0034"),orderBy:"itemLevel",width:100}),this.shouldRenderScoreColumn&&e.push({name:"score",title:c.tr("Score@@0035"),orderBy:"score",flex:1,width:200}),e}renderRow(e,t){return n.html`
		...
		`}renderContextMenu(e){return()=>n.html`
			...
			`}renderScoreNumber(e){return e.additionalPropertiesFor?e.score?n.html`${e.score}<span class="more">+</span>`:"+":e.score?n.html`${e.score}`:"--"}renderScoreGraph(e){let t=h.settings.data.scoreChartBorderSize;return n.html`<div class="score"
		...
		>
			...
			${e.additionalPropertiesFor||e.randomEnchantment?n.html`
				<div class="score-additional"
					:style.background-color=${new l.Color(d.qualityColors[e.quality]).alpha(.4)}
					:style.width=${t}
					:style.height=${t}
					:style.padding-right=${-t}
				/>
			`:""}
		</div>`}onCreated(){super.onCreated(),this.on("orderchanged",(e,t)=>{o.storage.set("comparerGridOrderName",e),o.storage.set("comparerGridOrderDirection",t)})}setAsCategoryIcon(e){this.closest(u.ItemComparer).setAsCategoryIcon(e)}openWowhead(e){a.wowheadResources.open(`/item=${e.id}`)}};p=s([n.define("comparer-grid")],p),i.ComparerGrid=p},{"../game/data-manager":12,"../translate":16,"../wowhead":17,"./item-comparer":6,"./quality-select":8,"./settings":9,ff:46,flit:75,fui:129}],5:[function(e,t,i){"use strict";function s(e){for(var t in e)i.hasOwnProperty(t)||(i[t]=e[t])}Object.defineProperty(i,"__esModule",{value:!0}),s(e("./button")),s(e("./item-comparer")),s(e("./comparer-grid")),s(e("./item")),s(e("./tooltip")),s(e("./side-select")),s(e("./quality-select")),s(e("./class-select")),s(e("./settings"))},{"./button":2,"./class-select":3,"./comparer-grid":4,"./item":7,"./item-comparer":6,"./quality-select":8,"./settings":9,"./side-select":10,"./tooltip":11}],6:[function(e,t,i){"use strict";var s=this&&this.__decorate||function(e,t,i,s){var n,r=arguments.length,o=r<3?t:null===s?s=Object.getOwnPropertyDescriptor(t,i):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(e,t,i,s);else for(var l=e.length-1;l>=0;l--)(n=e[l])&&(o=(r<3?n(o):r>3?n(t,i,o):n(t,i))||o);return r>3&&o&&Object.defineProperty(t,i,o),o};Object.defineProperty(i,"__esModule",{value:!0});const n=e("flit"),r=e("../game/data-manager"),o=e("ff"),l=e("fui"),a=e("../game/types"),h=e("./settings"),c=e("../game/item-ranking"),d=e("../game/item-property-weight"),u=e("../game/item-category"),p=e("../translate");let m=class extends n.Component{constructor(){super(...arguments),this.store=new l.Store({key:"id"}),this.generator=new u.CategoryGenerator}render(){return n.html`
		...
		/>
		`}renderClassRoles(){if(!this.generator.selectedClass)return"";let e=c.classRoles[this.generator.selectedClass].map(e=>{let{talent:t}=d.roleWeights[e],{name:i,icon:s}=r.dataManager.fixedData.classTalents[this.generator.selectedClass].find(e=>e.id===t);return e===d.ClassRole.DruidFeralCombatBear?i+=" - "+p.tr("Bear@@0011"):e===d.ClassRole.DruidFeralCombatCat&&(i+=" - "+p.tr("Cat@@0012"),s="ability_druid_catform"),{role:Number(e),icon:s,tooltip:i}});return e.unshift({role:null,icon:r.dataManager.fixedData.classes[this.generator.selectedClass].icon,tooltip:p.tr("Any talent@@0039"),category:null}),n.html`
		<div class="comparer-toolbar-line">
			<span>${p.tr("Ranking@@0013")}: </span>
			<div class="comparer-toolbar">
			${e.map(({role:e,tooltip:t,icon:i})=>n.html`
				<f-popup .hoverShowDelay="${1e3}" .alignPosition="b">
					<wow-button
						.icon=${i}
			...
			<div class="settings-body" slot="body">
				...
				<div class="settings-tabs">
					...
					<div class="settings-tab" :show=${"comparer"===this.tab}>
						...
						<div class="settings-line">
							<f-checkbox
								.checked=${i.settings.data.equipAcrossArmorTypes}
								@change=${e=>i.settings.set("equipAcrossArmorTypes",e)}
							>
								${a.tr("Equip across armor types@@0052")}${this.renderWhyCant()}
							</f-checkbox>
						</div>
						...
						<div class="settings-line" :disable=${i.settings.data.onlyShowScoreNumber}>
							...
							<f-select
								.data=${[[d.Thin,a.tr("Thin@@0044")],[d.Medium,a.tr("Medium@@0045")],[d.Thick,a.tr("Thick@@0046")],[d.VeryThick,a.tr("Very Thick@@0047")]].map(([e,t])=>[e,t+` - ${e}`])}
