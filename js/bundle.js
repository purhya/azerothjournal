!function(){return function e(t,i,s){function n(o,a){if(!i[o]){if(!t[o]){var l="function"==typeof require&&require;if(!a&&l)return l(o,!0);if(r)return r(o,!0);var h=new Error("Cannot find module '"+o+"'");throw h.code="MODULE_NOT_FOUND",h}var c=i[o]={exports:{}};t[o][0].call(c.exports,function(e){return n(t[o][1][e]||e)},c,c.exports,e,t,i,s)}return i[o].exports}for(var r="function"==typeof require&&require,o=0;o<s.length;o++)n(s[o]);return n}}()({1:[function(e,t,i){"use strict";var s=this&&this.__decorate||function(e,t,i,s){var n,r=arguments.length,o=r<3?t:null===s?s=Object.getOwnPropertyDescriptor(t,i):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(e,t,i,s);else for(var a=e.length-1;a>=0;a--)(n=e[a])&&(o=(r<3?n(o):r>3?n(t,i,o):n(t,i))||o);return r>3&&o&&Object.defineProperty(t,i,o),o};Object.defineProperty(i,"__esModule",{value:!0});const n=e("flit"),r=e("fui"),o=e("./game/data-manager"),a=e("ff");e("./components");const l=e("flit"),h=e("./translate"),c=e("./settings");window.flit=l,r.theme.changeTheme("dark"),r.theme.set("backgroundColor","#222"),r.theme.set("layerBackgroundColor",new r.Color("#222").lighten(5).toString()),r.theme.set("borderRadius",2),r.theme.set("layerBorderRadius",2),o.dataManager.baseReady.then(()=>{r.message.setLabels({ok:h.tr("OK@@0055"),cancel:h.tr("Cancel@@0056")})});let d=class extends r.Router{constructor(){super(...arguments),this.page=a.firstMatch(location.search,/\?(\w+)/),this.prepared=!1,this.selectedUserSideAndClass=a.storage.get("selectedUserSideAndClass",!1)}render(){if(!o.dataManager.fixedData)return null;if(!this.selectedUserSideAndClass)return n.html`<wow-app-entry
		...
		<template class="app-entry">
			<div class="app-entry-select">
				<div class="app-entry-select-line">
					...
					<side-select
						.value=${c.settings.data.userSide}
						@change=${e=>c.settings.set("userSide",e)}
					/>
				</div>
				...
				<div class="app-entry-select-line">
					...
					<class-select
						.value=${c.settings.data.userClass}
						@change=${e=>c.settings.set("userClass",e)}
					/>
				</div>
			</div>
